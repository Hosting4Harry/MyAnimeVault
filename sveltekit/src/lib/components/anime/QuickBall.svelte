...
<div
    role="none"
    class="fixed bottom-6 right-6 bg-gray-800 text-gray-200 p-4 rounded-full shadow-lg cursor-pointer transition-transform transform hover:scale-110"
...
>
    {#if isExpanded}
        <button
            class="bg-gray-800 text-gray-200 p-3 rounded-full shadow-md transition-all transform translate-y-0 opacity-100 duration-300 hover:scale-110"
            onclick={openDialog}
        >
            <Plus />
        </button>
